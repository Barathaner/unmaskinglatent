...
const size_t _numv = 4000;
    ...
    double* __restrict  _ptr_array_neurongroup_3_g_ampa = _array_neurongroup_3_g_ampa;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        double g_ampa = _ptr_array_neurongroup_3_g_ampa[_idx];
        double g_gaba = _ptr_array_neurongroup_3_g_gaba[_idx];
        ...
        if(not_refractory)
            v = _v;
        _ptr_array_neurongroup_3_g_ampa[_idx] = g_ampa;
        _ptr_array_neurongroup_3_g_gaba[_idx] = g_gaba;
