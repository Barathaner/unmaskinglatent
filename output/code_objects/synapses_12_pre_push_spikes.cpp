...
void _run_synapses_12_pre_push_spikes()
{
    ...
    ///// CONSTANTS ///////////
    const int32_t _n_sources = 3200;
const int32_t _n_targets = 800;
const size_t _num_source_dt = 1;
const size_t _num_spikespace = 4001;
...
const size_t _numdelay = _dynamic_array_synapses_12_delay.size();
    ...
    
    {
        ...
        synapses_12_pre.push(_ptr_array_neurongroup_2__spikespace, _ptr_array_neurongroup_2__spikespace[_num_spikespace-1]);
    }
